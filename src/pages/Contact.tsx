        ...
        <section className="py-16 bg-gradient-to-r from-primary to-secondary">
          <div className="container mx-auto px-4 text-center text-white">
            <div className="flex items-center justify-center mb-6">
              ...
              <h1 className="text-4xl md:text-6xl font-bold">{t('pages.contact.contactUs')}</h1>
            </div>
            <p className="text-xl md:text-2xl max-w-2xl mx-auto opacity-90">
              {t('pages.contact.weReHereToHelpGet')}
            </p>
          </div>
        </section>
        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="bg-card p-8 rounded-lg shadow-sm mb-12 border">
              <h2 className="text-2xl font-bold mb-6 text-center">{t('pages.contact.getInTouch')}</h2>
              <div className="space-y-8">
                <div className="flex items-start">
                  <Mail className="h-6 w-6 text-primary mr-4 mt-1" />
                  <div>
                    <h3 className="font-semibold mb-3">{t('pages.contact.emailSupport')}</h3>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">{t('pages.contact.officeAddress')}</h3>
                    <p className="text-muted-foreground">
                      {t('pages.contact.kinshasaRDCongo')}
                    </p>
                  </div>
                </div>
              </div>
