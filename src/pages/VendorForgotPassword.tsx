...
const VendorForgotPassword = () => {
  ...
  const requestOtp = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      const response = await fetch(`${API_BASE_URL}/auth/vendor/forgot-password`, {
        method: "POST",
        headers: {
  ...
  const resetPassword = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      const response = await fetch(`${API_BASE_URL}/auth/vendor/reset-password`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
              ...
              <form onSubmit={resetPassword} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    required
                    maxLength={6}
                    className="text-center tracking-widest border-muted focus:border-orange-600 focus:ring-orange-600"
                  />
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      required
                      minLength={8}
                      className="border-muted focus:border-orange-600 focus:ring-orange-600 pr-10"
                    />
                    <Button
                      type="button"
                      variant="ghost"
